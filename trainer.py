...
def collate_fn1(batch, processor):
        pixel_values = [item["pixel_values"] for item in batch]
        encoding = processor.pad(pixel_values, return_pixel_mask=True, return_tensors="pt")
...
def build_trainer(model, processor, datasets) -> Trainer:
    ...
    collate_fn = partial(collate_fn1, processor=processor)
